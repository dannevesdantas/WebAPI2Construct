...
3. Disable XML formatter inside the *Register* method in the *WebAPIConfig.cs*, it can be found at *App_Start* project's folder. It will make JSON the default format:
